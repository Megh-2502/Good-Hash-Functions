 ...
 * Name: Megh H. Shah
 * Batch: B3
 * Enrollment NO: 22002171210074
 * Roll No: 84
 * Branch: CSE
 * Topic: Implementation Of Hashing
 */
...
class goodHashFunction {
    ...
    static void multiplicationHash() {
        ...
        if (nkey > table_size) {
            ...
            // Multiplying the key by a random floating point number betn 0 & 1.
            // This effectively scales the key down to fractional value betn 0 and the
            // original key value.
            for (int i = 0; i < nkey; i++) {
                System.out.print("\t\t\t\t\t\t\tEnter Key: ");
                int key = sc.nextInt();
    ...
    /*
     * MidSquare Method
     * Enter size of Hash Table: 1000
     * How many key you want to enter: 1
     * 
     * Enter Key: 87431
     * 
     * Index 179: 87431
